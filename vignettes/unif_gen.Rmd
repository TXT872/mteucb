...
-  `significance_level`: The significance level for the construction of uniform confidence band. The default is 0.05.
...
By using `unif_gen()`, we obtain a confidence band of a MTE function with some other information.
```{r, eval = T, echo = T}
...
RESULT_unif$Estimation
RESULT_unif$critical_value
RESULT_unif$Plot
