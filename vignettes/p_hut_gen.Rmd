...
In this page, we introduce how to use `p_hut_gen()` for obtaining estimated propensity scores. 
...
By using `p_hut_gen()`, we obtain a data frame with the estimated propensity score.
```{r, eval = T, echo = T}
