...
-   `trim`: To mitigate the effect of ill behavior of estimtaed propensity scores, we set those less than the value of trim or larger than (1-the value of trim) as the value of the value of trim or (1-the value of trim).
...
-To estimate a semiparametric coefficient of MTE, we use a partial linear estimation based on an extension of separation method used in Carneiro and Lee (2009). For more details, see Tsuda, T, Jin, Y., & Okui, R. (2024+).

-Our theory is agnostic about the choice of coefficient estimator. Other estimators such as those studied in Carneiro and Lee (2009) and Heckman, James J., Sergio Urzua, and Edward J. Vytlacil (2006), can be used if their convergence rates are sufficiently fast
...
-   Heckman, James J., Sergio Urzua, and Edward J. Vytlacil (2006). “Understanding instru- mental variables in models with essential heterogeneity”. In: The Review of Economics and Statistics 88.3, pp. 389–432
